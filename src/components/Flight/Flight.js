...
function getFormattedStopsString(stops) {
  switch (stops.length) {
    case 0:
...
function getFormattedDurationString(duration) {
...
function getFormattedTimeString(date, durationMin) {
...
export function Flight({ className, segment }) {
